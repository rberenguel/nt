    ...
    const colorMap = {
        'v': 'color-violet', 'm': 'color-magenta', 'b': 'color-blue',
        'c': 'color-cyan', 'g': 'color-green', 'y': 'color-yellow',
        'o': 'color-orange', 'r': 'color-red',
    };
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        body.innerHTML = savedContent || '<div><!-- Select a letter (v,m,b,c,g,y,o,r,n) then Alt-click a line to style it. --></div>';
